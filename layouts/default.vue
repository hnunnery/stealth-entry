    ...
    <v-toolbar app scroll-off-screen>
      ...
      <v-toolbar-items class="hidden-md-and-down">
        ...
        <v-btn flat to="/services">
          <v-icon class="primary--text navbar-icons">fas fa-shield-alt</v-icon>&nbsp;
          <span class="nav-text secondary--text">Services</span>
        </v-btn>
        <v-btn flat to="/research">
        ...
        <v-btn flat to="/media">
          <v-icon class="primary--text navbar-icons">fas fa-newspaper</v-icon>&nbsp;
          <span class="nav-text secondary--text">Media</span>
        </v-btn>
