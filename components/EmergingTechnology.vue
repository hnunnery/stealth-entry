          ...
          <v-flex xs12 xl10>
            <v-layout wrap justify-center align-center class="pa-1 mt-4 partners-component">
              <v-flex xs12 sm6 lg4 class="text-xs-center py-3">
                <img
                  src="https://res.cloudinary.com/missionwebdev/image/upload/c_scale,f_auto,w_400/v1549808280/StealthEntry/TIQ_LOGO.webp"
                  alt="threat iq"
              ...
              <v-flex xs12 sm6 lg4 class="text-xs-center py-3">
                <img
                  src="https://res.cloudinary.com/missionwebdev/image/upload/c_scale,f_auto,w_250/v1550520877/StealthEntry/partners/Inner-View_-_Logo.png"
                  alt="inner-view"
                  class="responsive-img dts"
                >
              </v-flex>
